...
public class MaintenanceManagerAPI {
	...
	public Response createMaintenanceManager(String jsonData) {
	    try {
	        ...
	        if (lastname == null || firstname == null || age == 0 || address == null ||
	        		matricule == null || password == null || site.getId() == 0){
	            return Response
	            		.status(Status.BAD_REQUEST)
	            		.build();
	        }
	        MaintenanceManager maintenanceManager = new MaintenanceManager(
	        		0,lastname,firstname,age,address,matricule,password,site,null);
